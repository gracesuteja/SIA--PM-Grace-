<%-- 
    Document   : hakakses_input
    Created on : Apr 8, 2013, 2:36:49 PM
    Author     : Fiveriel
--%>
                                        ...
                                        <td width="318" valign="top"><table width="318" border="0" cellspacing="0" cellpadding="0">
                                                ...
                                                <tr>
                                                    <td valign="top" bgcolor="#F0E2D0" style="padding-top:15px; padding-bottom:15px;"><table width="295" border="0" align="center" cellpadding="0" cellspacing="0">
                                                            ...
                                                            <form id="form_hak" name="form_hak" method="post" action="">
                                                                <tr>
                                                                    <td height="35" colspan="3" valign="top" class="heading" style="padding-top:8px; color:#0066FF;"><span class="style2"><strong>HAK AKSES :</strong></span></td>
                                                                </tr>
                                                                <tr>
                                                                    <td width="34%" class="body">ID Akses :</td>
                                                                    <td width="66%" colspan="2"><input type="text" name="hakakses_id" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">Pengakses :</td>
                                                                    <td colspan="2"><input type="text" name="hakakses_pengakses" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">Edit :</td>
                                                                    <td colspan="2"><input type="text" name="hakakses_edit" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body"> Modul Data User :</td>
                                                                    <td colspan="2"><input type="text" name="hakakses_mod_dat_user" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">Modul data mahasiswa dosen  staff:</td>
                                                                    <td colspan="2"><input type="text" name="hakakses_mod_data_mhs_dsn_staf" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">Modul Mata Kuliah pengajar:</td>
                                                                    <td colspan="2"><input type="text" name="hakakses_mod_matkul " style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">Modul Nilai Transkip Mahasiswa:</td>
                                                                    <td colspan="2"><input type="text" name="hakakses_mod_transkip" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">Modul Keuangan :</td>
                                                                    <td colspan="2"><input type="text" name="hakakses_mod_keuangan" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">Modul Bahan Kuliah :</td>
                                                                    <td colspan="2"><input type="text" name="hakakses_mod_bahankul" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">Modul KRS Online :</td>
                                                                    <td colspan="2"><input type="text" name="hakakses_mod_krs" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">Modul Backup :</td>
                                                                    <td colspan="2"><input type="text" name="hakakses_mod_backup" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">Modul Absensi Mahasiswa :</td>
                                                                    <td colspan="2"><input type="text" name="hakakses_mod_absensi" style="width:180px; height:13px;" /></td>
                                                                </tr>
