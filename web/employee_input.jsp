<%-- 
    Document   : employee_input
    Created on : Apr 8, 2013, 2:34:03 PM
    Author     : Fiveriel
--%>
                                        ...
                                        <td width="318" valign="top"><table width="318" border="0" cellspacing="0" cellpadding="0">
                                                ...
                                                <tr>
                                                    <td valign="top" bgcolor="#F0E2D0" style="padding-top:15px; padding-bottom:15px;"><table width="295" border="0" align="center" cellpadding="0" cellspacing="0">
                                                            ...
                                                            <form id="form_employe" name="form_employee" method="post" action="">
                                                                <tr>
                                                                    <td height="35" colspan="3" valign="top" class="heading" style="padding-top:8px; color:#0066FF;"><span class="style2"><strong>EMPLOYEE :</strong></span></td>
                                                                </tr>
                                                                <tr>
                                                                    <td width="34%" class="body">NIK :</td>
                                                                    <td width="66%" colspan="2"><input type="text" name="employee_nik" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">Nama :</td>
                                                                    <td colspan="2"><input type="text" name="employee_nama" style="width:180px; height:13px;" /></td>
                                                                </tr>
