<%-- 
    Document   : biaya_input
    Created on : Apr 8, 2013, 7:32:35 AM
    Author     : DonnyEff
--%>
                                        ...
                                        <td width="318" valign="top"><table width="318" border="0" cellspacing="0" cellpadding="0">
                                                ...
                                                <tr>
                                                    <td valign="top" bgcolor="#F0E2D0" style="padding-top:15px; padding-bottom:15px;"><table width="295" border="0" align="center" cellpadding="0" cellspacing="0">
                                                            ...
                                                            <form id="form_biaya" name="form_biaya" method="post" action="">
                                                                <tr>
                                                                    <td height="35" colspan="3" valign="top" class="heading" style="padding-top:8px; color:#0066FF;"><span class="style2"><strong>BIAYA :</strong></span></td>
                                                                </tr>
                                                                <tr>
                                                                    <td width="34%" class="body">ANGKATAN:</td>
                                                                    <td width="66%" colspan="2"><input type="text" name="biaya_angkatan" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">B_SKS:</td>
                                                                    <td colspan="2"><input type="text" name="biaya_bsks" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">B_SEMESTER:</td>
                                                                    <td colspan="2"><input type="text" name="biaya_semester" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>&nbsp;</td>
                                                                    <td colspan="2">
