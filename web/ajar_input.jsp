<%-- 
    Document   : ajar_input
    Created on : Apr 8, 2013, 7:24:41 AM
    Author     : DonnyEff
--%>
                                        ...
                                        <td width="318" valign="top"><table width="318" border="0" cellspacing="0" cellpadding="0">
                                                ...
                                                <tr>
                                                    <td valign="top" bgcolor="#F0E2D0" style="padding-top:15px; padding-bottom:15px;"><table width="295" border="0" align="center" cellpadding="0" cellspacing="0">
                                                            ...
                                                            <form id="form_ajar" name="form_ajar" method="post" action="">
                                                                <tr>
                                                                    <td height="35" colspan="3" valign="top" class="heading" style="padding-top:8px; color:#0066FF;"><span class="style2"><strong>AJAR :</strong></span></td>
                                                                </tr>
                                                                <tr>
                                                                    <td width="34%" class="body">NIKD:</td>
                                                                    <td width="66%" colspan="2"><input type="text" name="ajar_Nikd" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">KODE MK:</td>
                                                                    <td colspan="2"><input type="text" name="ajar_kodemk" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">ID_PERIODIK:</td>
                                                                    <td colspan="2"><input type="text" name="ajar_periodik" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">BOBOT 1:</td>
                                                                    <td colspan="2"><input type="text" name="ajar_bobot1" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">BOBOT 2:</td>
                                                                    <td colspan="2"><input type="text" name="ajar_bobot2" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">BOBOT 3:</td>
                                                                    <td colspan="2"><input type="text" name="ajar_bobot3" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">BOBOT 4:</td>
                                                                    <td colspan="2"><input type="text" name="ajar_bobot4" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">BOBOT 5:</td>
                                                                    <td colspan="2"><input type="text" name="ajar_bobot5" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>&nbsp;</td>
                                                                    <td colspan="2">
