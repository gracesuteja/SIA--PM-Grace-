<%-- 
    Document   : absensi_input
    Created on : Apr 8, 2013, 7:19:42 AM
    Author     : DonnyEff
--%>
                                        ...
                                        <td width="318" valign="top"><table width="318" border="0" cellspacing="0" cellpadding="0">
                                                ...
                                                <tr>
                                                    <td valign="top" bgcolor="#F0E2D0" style="padding-top:15px; padding-bottom:15px;"><table width="295" border="0" align="center" cellpadding="0" cellspacing="0">
                                                            ...
                                                            <form id="formabsen" name="form_absensi" method="post" action="">
                                                                <tr>
                                                                    <td height="35" colspan="3" valign="top" class="heading" style="padding-top:8px; color:#0066FF;"><span class="style2"><strong>ABSENSI:</strong></span></td>
                                                                </tr>
                                                                <tr>
                                                                    <td width="34%" class="body">NIM:</td>
                                                                    <td width="66%" colspan="2"><input type="text" name="absensi_nim" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">NIKD:</td>
                                                                    <td colspan="2"><input type="text" name="absensi_nikd" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">KODE MK:</td>
                                                                    <td colspan="2"><input type="text" name="absensi_mk" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">NO RUANGAN:</td>
                                                                    <td colspan="2"><input type="text" name="absensi_no " style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">TANGGAL:</td>
                                                                    <td colspan="2"><input type="text" name="DD" style="width:50px; height:13px;" />
                                                                        <input type="text" name="MM" style="width:50px; height:13px;" />
                                                                        <input type="text" name="YY" style="width:50px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">KETERANGAN:</td>
                                                                    <td colspan="2"><textarea name="textarea" rows="5" cols="" style="width:180px;"></textarea></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>&nbsp;</td>
                                                                    <td colspan="2">
