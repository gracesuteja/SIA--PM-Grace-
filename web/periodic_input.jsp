<%-- 
    Document   : jadwal_i nput
    Created on : Apr 8, 2013, 2:37:06 PM
    Author     : Fiveriel
--%>
                                        ...
                                        <td width="318" valign="top"><table width="318" border="0" cellspacing="0" cellpadding="0">
                                                ...
                                                <tr>
                                                    <td valign="top" bgcolor="#F0E2D0" style="padding-top:15px; padding-bottom:15px;"><table width="295" border="0" align="center" cellpadding="0" cellspacing="0">
                                                            ...
                                                            <form id="form_periodic" name="form2" method="post" action="">
                                                                <tr>
                                                                    <td height="35" colspan="3" valign="top" class="heading" style="padding-top:8px; color:#0066FF;"><span class="style2"><strong>PERIODIC :</strong></span></td>
                                                                </tr>
                                                                <tr>
                                                                    <td width="34%" class="body">ID Periodic:</td>
                                                                    <td width="66%" colspan="2"><input type="text" name="periodic_id_periodic" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">Tahun mulai:</td>
                                                                    <td colspan="2"><input type="text" name="periodic_tahun_mulai" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">Tahun akhir:</td>
                                                                    <td colspan="2"><input type="text" name="periodic_tahun_akhir" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body"> Tanggal kuliah:</td>
                                                                    <td colspan="2"><input type="text" name="periodic_tanggal_kuliah_1" style="width:50px; height:13px;" />
                                                                    <input type="text" name="periodic_tanggal_kuliah_2" style="width:50px; height:13px;" />
                                                                    <input type="text" name="periodic_tanggal_kuliah_3" style="width:50px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body"> Tanggal akhir kuliah:</td>
                                                                    <td colspan="2"><input type="text" name="periodic_tanggal_akhir_kuliah_1" style="width:50px; height:13px;" />
                                                                    <input type="text" name="periodic_tanggal_akhir_kuliah_2" style="width:50px; height:13px;" />
                                                                    <input type="text" name="periodic_tanggal_akhir_kuliah_3" style="width:50px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body"> Tanggal KRS:</td>
                                                                    <td colspan="2"><input type="text" name="periodic_tanggal_KRS_1" style="width:50px; height:13px;" />
                                                                    <input type="text" name="periodic_tanggal_KRS_2" style="width:50px; height:13px;" />
                                                                    <input type="text" name="periodic_tanggal_KRS_3" style="width:50px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body"> Tanggal PRS:</td>
                                                                    <td colspan="2"><input type="text" name="periodic_tanggal_PRS_1" style="width:50px; height:13px;" />
                                                                    <input type="text" name="periodic_tanggal_PRS_2" style="width:50px; height:13px;" />
                                                                    <input type="text" name="periodic_tanggal_PRS_3" style="width:50px; height:13px;" /></td>
                                                                </tr>
