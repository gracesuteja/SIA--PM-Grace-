                                        ...
                                        <td width="318" valign="top"><table width="318" border="0" cellspacing="0" cellpadding="0">
                                                ...
                                                <tr>
                                                    <td valign="top" bgcolor="#F0E2D0" style="padding-top:15px; padding-bottom:15px;"><table width="295" border="0" align="center" cellpadding="0" cellspacing="0">
                                                            <form id="form_mahasiswa" name="form2" method="post" action="">
                                                                <tr>
                                                                    <td height="35" colspan="3" valign="top" class="heading" style="padding-top:8px; color:#0066FF;"><span class="style2"><strong>MAHASISWA :</strong></span></td>
                                                                </tr>
                                                                <tr>
                                                                    <td width="34%" class="body">NIM:</td>
                                                                    <td width="66%" colspan="2"><input type="text" name="mahasiswa_nim" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">Nama:</td>
                                                                    <td colspan="2"><input type="text" name="mahasiswa_nama" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">Angkatan:</td>
                                                                    <td colspan="2"><input type="text" name="mahasiswa_angkatan" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body"> ID ortu:</td>
                                                                    <td colspan="2"><input type="text" name="mahasiswa_id_ortu" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">Pass ortu:</td>
                                                                    <td colspan="2"><input type="text" name="mahasiswa_pass_ortu" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">Pass mahasiswa:</td>
                                                                    <td colspan="2"><input type="text" name="mahasiswa_pass_mhs" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">Status:</td>
                                                                    <td colspan="2"><input type="text" name="mahasiswa_status" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">Alumni:</td>
                                                                    <td colspan="2"><input type="text" name="mahasiswa_alumni" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">ID_Dept:</td>
                                                                    <td colspan="2"><input type="text" name="mahasiswa_id_dept" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">ID Akses:</td>
                                                                    <td colspan="2"><input type="text" name="mahasiswa_id_akses" style="width:180px; height:13px;" /></td>
                                                                </tr>
