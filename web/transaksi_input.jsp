<%-- 
    Document   : transaksi
    Created on : Apr 8, 2013, 7:48:16 AM
    Author     : DonnyEff
--%>
                                        ...
                                        <td width="318" valign="top"><table width="318" border="0" cellspacing="0" cellpadding="0">
                                                ...
                                                <tr>
                                                    <td valign="top" bgcolor="#F0E2D0" style="padding-top:15px; padding-bottom:15px;"><table width="295" border="0" align="center" cellpadding="0" cellspacing="0">
                                                            ...
                                                            <form id="form2" name="form_transaksi" method="post" action="">
                                                                <tr>
                                                                    <td height="35" colspan="3" valign="top" class="heading" style="padding-top:8px; color:#0066FF;"><span class="style2"><strong>TRANSAKSI :</strong></span></td>
                                                                </tr>
                                                                <tr>
                                                                    <td width="34%" class="body">NIM:</td>
                                                                    <td width="66%" colspan="2"><input type="text" name="transaksi_nim" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">KODE_MK:</td>
                                                                    <td colspan="2"><input type="text" name="transaksi_kode_mk" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">ANGKATAN:</td>
                                                                    <td colspan="2"><input type="text" name="transaksi_angkatan" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">ID_PERIODIK:</td>
                                                                    <td colspan="2"><input type="text" name="transaksi_id_periodik" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">TANGGAL_BAYAR:</td>
                                                                    <td colspan="2"><input type="text" name="transaksi_tanggal_bayar" style="width:50px; height:13px;" />
                                                                        <input type="text" name="MM" style="width:50px; height:13px;" />
                                                                        <input type="text" name="YY" style="width:50px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">STATUS_BAYAR:</td>
                                                                    <td colspan="2"><input type="text" nama="transaksi_status_bayar" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>&nbsp;</td>
                                                                    <td colspan="2">
