<%-- 
    Document   : bahankul_input
    Created on : Apr 8, 2013, 7:29:52 AM
    Author     : DonnyEff
--%>
                                        ...
                                        <td width="318" valign="top"><table width="318" border="0" cellspacing="0" cellpadding="0">
                                                ...
                                                <tr>
                                                    <td valign="top" bgcolor="#F0E2D0" style="padding-top:15px; padding-bottom:15px;"><table width="295" border="0" align="center" cellpadding="0" cellspacing="0">
                                                            ...
                                                            <form id="form_bahankul" name="form_bahankul" method="post" action="">

                                                                <tr>
                                                                    <td height="35" colspan="3" valign="top" class="heading" style="padding-top:8px; color:#0066FF;"><span class="style2"><strong>BAHAN KULIAH :</strong></span></td>
                                                                </tr>
                                                                <tr>
                                                                    <td width="34%" class="body">ID_BAHAN:</td>
                                                                    <td width="66%" colspan="2"><input type="text" name="bahankul_id" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">MATERI:</td>
                                                                    <td colspan="2"><input type="text" name="bahankul_materi" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">LINK_DOWNLOAD:</td>
                                                                    <td colspan="2"><input type="text" name="bahankul_link" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">SIZE:</td>
                                                                    <td colspan="2"><input type="text" name="bahankul_size" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">KODE_MK:</td>
                                                                    <td colspan="2"><input type="text" name="bahankul_kodemk" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>&nbsp;</td>
                                                                    <td colspan="2">
