                                        ...
                                        <td width="318" valign="top"><table width="318" border="0" cellspacing="0" cellpadding="0">
                                                ...
                                                <tr>
                                                    <td valign="top" bgcolor="#F0E2D0" style="padding-top:15px; padding-bottom:15px;"><table width="295" border="0" align="center" cellpadding="0" cellspacing="0">
                                                            ...
                                                            <form id="form_jadwal" name="form_jadwal" method="post" action="">
                                                                <tr>
                                                                    <td height="35" colspan="3" valign="top" class="heading" style="padding-top:8px; color:#0066FF;"><span class="style2"><strong>JADWAL :</strong></span></td>
                                                                </tr>
                                                                <tr>
                                                                    <td width="34%" class="body">No. Ruangan :</td>
                                                                    <td width="66%" colspan="2"><input type="text" name="jadwal_no_ruangan" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">NIKD:</td>
                                                                    <td colspan="2"><input type="text" name="jadwal_nikd" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">Kode Mata Kuliah:</td>
                                                                    <td colspan="2"><input type="text" name="jadwal_kode_matkul" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body"> Jam Mulai:</td>
                                                                    <td colspan="2"><input type="text" name="jadwal_jam_mulai" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">Jam Akhir :</td>
                                                                    <td colspan="2"><input type="text" name="jadwal_jam_akhir" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">Hari :</td>
                                                                    <td colspan="2"><input type="text" name="jadwal_hari"" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">kelas :</td>
                                                                    <td colspan="2"><input type="text" name="jadwal_kelas" style="width:180px; height:13px;" /></td>
                                                                </tr>
