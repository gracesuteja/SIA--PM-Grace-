<%-- 
    Document   : department_input
    Created on : Apr 8, 2013, 7:38:34 AM
    Author     : DonnyEff
--%>
                                        ...
                                        <td width="318" valign="top"><table width="318" border="0" cellspacing="0" cellpadding="0">
                                                ...
                                                <tr>
                                                    <td valign="top" bgcolor="#F0E2D0" style="padding-top:15px; padding-bottom:15px;"><table width="295" border="0" align="center" cellpadding="0" cellspacing="0">
                                                            ...
                                                            <form id="form_departement" name="form_department" method="post" action="">
                                                                <tr>
                                                                    <td height="35" colspan="3" valign="top" class="heading" style="padding-top:8px; color:#0066FF;"><span class="style2"><strong>DEPARTMENT :</strong></span></td>
                                                                </tr>
                                                                <tr>
                                                                    <td width="34%" class="body">ID_DEPT:</td>
                                                                    <td width="66%" colspan="2"><input type="text" name="department_id" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">NAMA_JURUSAN:</td>
                                                                    <td colspan="2"><input type="text" name="department_jurusan" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">NIKD:</td>
                                                                    <td colspan="2"><input type="text" name=department_nikd" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">ID_FAKULTAS:</td>
                                                                    <td colspan="2"><input type="text" name="department_fakultas" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>&nbsp;</td>
                                                                    <td colspan="2"><tr>
