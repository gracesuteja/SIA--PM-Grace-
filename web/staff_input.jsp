<%-- 
    Document   : staff
    Created on : Apr 8, 2013, 7:45:50 AM
    Author     : DonnyEff
--%>
                                        ...
                                        <td width="318" valign="top"><table width="318" border="0" cellspacing="0" cellpadding="0">
                                                ...
                                                <tr>
                                                    <td valign="top" bgcolor="#F0E2D0" style="padding-top:15px; padding-bottom:15px;"><table width="295" border="0" align="center" cellpadding="0" cellspacing="0">
                                                            ...
                                                            <form id="form2" name="form_staff" method="post" action="">
                                                                <tr>
                                                                    <td height="35" colspan="3" valign="top" class="heading" style="padding-top:8px; color:#0066FF;"><span class="style2"><strong>STAFF :</strong></span></td>
                                                                </tr>
                                                                <tr>
                                                                    <td width="34%" class="body">NIKS:</td>
                                                                    <td width="66%" colspan="2"><input type="text" name="staff_niks" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">NAMA:</td>
                                                                    <td colspan="2"><input type="text" name="staff_nama" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">PASS_ST:</td>
                                                                    <td colspan="2"><input type="text" name="staff_password" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">ID_AKSES:</td>
                                                                    <td colspan="2"><input type="text" name="staff_id_akses" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>&nbsp;</td>
                                                                    <td colspan="2">
