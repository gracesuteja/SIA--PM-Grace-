<%-- 
    Document   : dosen_input
    Created on : Apr 8, 2013, 2:29:11 PM
    Author     : Fiveriel
--%>
                                        ...
                                        <td width="318" valign="top"><table width="318" border="0" cellspacing="0" cellpadding="0">
                                                ...
                                                <tr>
                                                    <td valign="top" bgcolor="#F0E2D0" style="padding-top:15px; padding-bottom:15px;"><table width="295" border="0" align="center" cellpadding="0" cellspacing="0">
                                                            ...
                                                            <form id="form_dosen" name="form_dosen" method="post" action="">
                                                                <tr>
                                                                    <td height="35" colspan="3" valign="top" class="heading" style="padding-top:8px; color:#0066FF;"><span class="style2"><strong>DOSEN :</strong></span></td>
                                                                </tr>
                                                                <tr>
                                                                    <td width="34%" class="body">NIKD :</td>
                                                                    <td width="66%" colspan="2"><input type="text" name="dosen_nik" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">Nama :</td>
                                                                    <td colspan="2"><input type="text" name="dosen_nama" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">Jabatan :</td>
                                                                    <td colspan="2"><input type="text" name="dosen_jabatan" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body"> Password :</td>
                                                                    <td colspan="2"><input type="text" name="dosen_password" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">ID akses :</td>
                                                                    <td colspan="2"><input type="text" name="dosen_id_akses" style="width:180px; height:13px;" /></td>
                                                                </tr>
