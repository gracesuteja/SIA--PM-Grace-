                                        ...
                                        <td width="318" valign="top"><table width="318" border="0" cellspacing="0" cellpadding="0">
                                                ...
                                                <tr>
                                                    <td valign="top" bgcolor="#F0E2D0" style="padding-top:15px; padding-bottom:15px;"><table width="295" border="0" align="center" cellpadding="0" cellspacing="0">
                                                            ...
                                                            <form id="form_matkul" name="form2" method="post" action="">
                                                                <tr>
                                                                    <td height="35" colspan="3" valign="top" class="heading" style="padding-top:8px; color:#0066FF;"><span class="style2"><strong>MATKUL :</strong></span></td>
                                                                </tr>
                                                                <tr>
                                                                    <td width="34%" class="body">Kode MK:</td>
                                                                    <td width="66%" colspan="2"><input type="text" name="matkul_kode_mk" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">Nama MK:</td>
                                                                    <td colspan="2"><input type="text" name="matkul_nama_mk" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">Jumlah SKS:</td>
                                                                    <td colspan="2"><input type="text" name="matkul_jumlah_sks" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body"> Keterangan Semester:</td>
                                                                    <td colspan="2"><input type="text" name="matkul_keterangan_semester" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">Sifat:</td>
                                                                    <td colspan="2"><input type="text" name="matkul_keterangan_sifat" style="width:180px; height:13px;" /></td>
                                                                </tr>
