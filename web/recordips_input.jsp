                                        ...
                                        <td width="318" valign="top"><table width="318" border="0" cellspacing="0" cellpadding="0">
                                                ...
                                                <tr>
                                                    <td valign="top" bgcolor="#F0E2D0" style="padding-top:15px; padding-bottom:15px;"><table width="295" border="0" align="center" cellpadding="0" cellspacing="0">
                                                            ...
                                                            <form id="form_recordips" name="form2" method="post" action="">
                                                                <tr>
                                                                    <td height="35" colspan="3" valign="top" class="heading" style="padding-top:8px; color:#0066FF;"><span class="style2"><strong>RECORD IPS:</strong></span></td>
                                                                </tr>
                                                                <tr>
                                                                    <td width="34%" class="body">ID Semester:</td>
                                                                    <td width="66%" colspan="2"><input type="text" name="recordips_id_semester" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">ID Periodic:</td>
                                                                    <td colspan="2"><input type="text" name="recordips_id_periodic" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body">NIM:</td>
                                                                    <td colspan="2"><input type="text" name="recordips_nim" style="width:180px; height:13px;" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="body"> Nilai IPS:</td>
                                                                    <td colspan="2"><input type="text" name="recordips_nilai_ips" style="width:180px; height:13px;" /></td>
                                                                </tr>
