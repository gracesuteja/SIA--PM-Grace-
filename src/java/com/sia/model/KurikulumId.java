...
/**
 * KurikulumId generated by hbm2java
 */
public class KurikulumId  implements java.io.Serializable {
    ...
    public KurikulumId(int kodeMk, int idDept, int idPeriodic) {
       this.kodeMk = kodeMk;
       this.idDept = idDept;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof KurikulumId) ) return false;
		 KurikulumId castOther = ( KurikulumId ) other; 
